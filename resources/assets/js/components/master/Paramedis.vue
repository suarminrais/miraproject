      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Daftar Paramedis</h3>
...
export default {
  ...
  methods: {
    getResults(page = 1) {
      axios.get("api/paramedis?page=" + page).then(response => {
    ...
    updateUser() {
      ...
      this.form
        .put("api/paramedis/" + this.form.id)
        .then(() => {
          // success
          $("#addNew").modal("hide");
    ...
    loadUsers() {
      if (this.$gate.isAdminOrAuthor()) {
        axios.get("api/paramedis").then(({ data }) => (this.dokters = data));
      }
    },
